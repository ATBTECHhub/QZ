import { dashboardWidget } from "../constants/data";

const Widget = () => {
  return (
    <div className="flex items-center gap-8">
      {dashboardWidget.map((widget, index) => (
        <div key={index} className="bg-white flex items-center py-[22px] pl-[27px] pr-10 rounded-[12px] gap-[18px]">
          <div
